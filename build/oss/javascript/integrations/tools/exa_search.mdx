...
We can also invoke the tool with a model-generated `ToolCall`, in which case a [`ToolMessage`](https://reference.langchain.com/javascript/classes/_langchain_core.messages_tool.ToolMessage.html) will be returned:
